...
**Evidence:** `lib/pulsar/components/accordion.ex`,
...
**Evidence:** `lib/pulsar/components/accordion.ex`, `accordion/1`
...
**Evidence:** `lib/pulsar/components/accordion.ex`, hook `setup`
