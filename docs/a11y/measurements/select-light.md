# Select — a11y measurements (light)
...
|---------|-----|-------|--------|--------|------|--------|-------|
| `ghost-danger-lg-default` | `select` | 311.33 | 48 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-danger-lg-disabled` | `select` | 311.33 | 48 | ✓ | 6.14:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `ghost-danger-lg-invalid` | `select` | 311.33 | 48 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-danger-lg-required` | `select` | 311.34 | 48 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-danger-md-default` | `select` | 311.33 | 40 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-danger-md-disabled` | `select` | 311.34 | 40 | ✓ | 6.14:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `ghost-danger-md-invalid` | `select` | 311.33 | 40 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-danger-md-required` | `select` | 311.33 | 40 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-danger-sm-default` | `select` | 311.34 | 32 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-danger-sm-disabled` | `select` | 311.33 | 32 | ✓ | 6.14:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `ghost-danger-sm-invalid` | `select` | 311.34 | 32 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-danger-sm-required` | `select` | 311.33 | 32 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-danger-xs-default` | `select` | 311.33 | 24 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-danger-xs-disabled` | `select` | 311.33 | 24 | ✓ | 6.14:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `ghost-danger-xs-invalid` | `select` | 311.33 | 24 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-danger-xs-required` | `select` | 311.34 | 24 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
...
| `ghost-neutral-lg-invalid` | `select` | 311.33 | 48 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
...
| `ghost-neutral-md-invalid` | `select` | 311.34 | 40 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
...
| `ghost-neutral-sm-invalid` | `select` | 311.33 | 32 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
...
| `ghost-neutral-xs-invalid` | `select` | 311.33 | 24 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-neutral-xs-required` | `select` | 311.33 | 24 | ✓ | 19.27:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-primary-lg-default` | `select` | 311.33 | 48 | ✓ | 6.54:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-primary-lg-disabled` | `select` | 311.33 | 48 | ✓ | 6.54:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `ghost-primary-lg-invalid` | `select` | 311.33 | 48 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-primary-lg-required` | `select` | 311.34 | 48 | ✓ | 6.54:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-primary-md-default` | `select` | 311.33 | 40 | ✓ | 6.54:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-primary-md-disabled` | `select` | 311.34 | 40 | ✓ | 6.54:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `ghost-primary-md-invalid` | `select` | 311.33 | 40 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-primary-md-required` | `select` | 311.33 | 40 | ✓ | 6.54:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-primary-sm-default` | `select` | 311.34 | 32 | ✓ | 6.54:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-primary-sm-disabled` | `select` | 311.33 | 32 | ✓ | 6.54:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `ghost-primary-sm-invalid` | `select` | 311.34 | 32 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-primary-sm-required` | `select` | 311.33 | 32 | ✓ | 6.54:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-primary-xs-default` | `select` | 311.33 | 24 | ✓ | 6.54:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-primary-xs-disabled` | `select` | 311.33 | 24 | ✓ | 6.54:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `ghost-primary-xs-invalid` | `select` | 311.33 | 24 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-primary-xs-required` | `select` | 311.34 | 24 | ✓ | 6.54:1 ✓ | — (no-border) | 5.02:1 ✓ |
...
| `ghost-secondary-lg-invalid` | `select` | 311.34 | 48 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
...
| `ghost-secondary-md-invalid` | `select` | 311.33 | 40 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
...
| `ghost-secondary-sm-invalid` | `select` | 311.33 | 32 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
...
| `ghost-secondary-xs-invalid` | `select` | 311.34 | 24 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-secondary-xs-required` | `select` | 311.33 | 24 | ✓ | 5.64:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-success-lg-default` | `select` | 311.33 | 48 | ✓ | 8.66:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-success-lg-disabled` | `select` | 311.34 | 48 | ✓ | 8.66:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `ghost-success-lg-invalid` | `select` | 311.33 | 48 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-success-lg-required` | `select` | 311.33 | 48 | ✓ | 8.66:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-success-md-default` | `select` | 311.34 | 40 | ✓ | 8.66:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-success-md-disabled` | `select` | 311.33 | 40 | ✓ | 8.66:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `ghost-success-md-invalid` | `select` | 311.34 | 40 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-success-md-required` | `select` | 311.33 | 40 | ✓ | 8.66:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-success-sm-default` | `select` | 311.33 | 32 | ✓ | 8.66:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-success-sm-disabled` | `select` | 311.33 | 32 | ✓ | 8.66:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `ghost-success-sm-invalid` | `select` | 311.33 | 32 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-success-sm-required` | `select` | 311.34 | 32 | ✓ | 8.66:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-success-xs-default` | `select` | 311.33 | 24 | ✓ | 8.66:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-success-xs-disabled` | `select` | 311.34 | 24 | ✓ | 8.66:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `ghost-success-xs-invalid` | `select` | 311.33 | 24 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-success-xs-required` | `select` | 311.33 | 24 | ✓ | 8.66:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-warning-lg-default` | `select` | 311.34 | 48 | ✓ | 8.67:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-warning-lg-disabled` | `select` | 311.33 | 48 | ✓ | 8.67:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `ghost-warning-lg-invalid` | `select` | 311.34 | 48 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-warning-lg-required` | `select` | 311.33 | 48 | ✓ | 8.67:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-warning-md-default` | `select` | 311.33 | 40 | ✓ | 8.67:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-warning-md-disabled` | `select` | 311.33 | 40 | ✓ | 8.67:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `ghost-warning-md-invalid` | `select` | 311.33 | 40 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-warning-md-required` | `select` | 311.34 | 40 | ✓ | 8.67:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-warning-sm-default` | `select` | 311.33 | 32 | ✓ | 8.67:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-warning-sm-disabled` | `select` | 311.34 | 32 | ✓ | 8.67:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `ghost-warning-sm-invalid` | `select` | 311.33 | 32 | ✓ | 6.14:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-warning-sm-required` | `select` | 311.33 | 32 | ✓ | 8.67:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `ghost-warning-xs-default` | `select` | 311.34 | 24 | ✓ | 8.67:1 ✓ | — (no-border) | 5.02:1 ✓ |
...
| `solid-danger-lg-required` | `select` | 311.34 | 48 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-danger-md-default` | `select` | 311.33 | 40 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-danger-md-disabled` | `select` | 311.34 | 40 | ✓ | 5.08:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `solid-danger-md-invalid` | `select` | 311.33 | 40 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-danger-md-required` | `select` | 311.33 | 40 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-danger-sm-default` | `select` | 311.34 | 32 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-danger-sm-disabled` | `select` | 311.33 | 32 | ✓ | 5.08:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `solid-danger-sm-invalid` | `select` | 311.34 | 32 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-danger-sm-required` | `select` | 311.33 | 32 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-danger-xs-default` | `select` | 311.33 | 24 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-danger-xs-disabled` | `select` | 311.33 | 24 | ✓ | 5.08:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `solid-danger-xs-invalid` | `select` | 311.33 | 24 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-danger-xs-required` | `select` | 311.34 | 24 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-neutral-lg-default` | `select` | 311.33 | 48 | ✓ | 16.62:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-neutral-lg-disabled` | `select` | 311.34 | 48 | ✓ | 16.62:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `solid-neutral-lg-invalid` | `select` | 311.33 | 48 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-neutral-lg-required` | `select` | 311.33 | 48 | ✓ | 16.62:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-neutral-md-default` | `select` | 311.34 | 40 | ✓ | 16.62:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-neutral-md-disabled` | `select` | 311.33 | 40 | ✓ | 16.62:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `solid-neutral-md-invalid` | `select` | 311.34 | 40 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-neutral-md-required` | `select` | 311.33 | 40 | ✓ | 16.62:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-neutral-sm-default` | `select` | 311.33 | 32 | ✓ | 16.62:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-neutral-sm-disabled` | `select` | 311.33 | 32 | ✓ | 16.62:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `solid-neutral-sm-invalid` | `select` | 311.33 | 32 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-neutral-sm-required` | `select` | 311.34 | 32 | ✓ | 16.62:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-neutral-xs-default` | `select` | 311.33 | 24 | ✓ | 16.62:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-neutral-xs-disabled` | `select` | 311.34 | 24 | ✓ | 16.62:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `solid-neutral-xs-invalid` | `select` | 311.33 | 24 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-neutral-xs-required` | `select` | 311.33 | 24 | ✓ | 16.62:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-primary-lg-default` | `select` | 311.33 | 48 | ✓ | 5.56:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-primary-lg-disabled` | `select` | 311.33 | 48 | ✓ | 5.56:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `solid-primary-lg-invalid` | `select` | 311.33 | 48 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-primary-lg-required` | `select` | 311.34 | 48 | ✓ | 5.56:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-primary-md-default` | `select` | 311.33 | 40 | ✓ | 5.56:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-primary-md-disabled` | `select` | 311.34 | 40 | ✓ | 5.56:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `solid-primary-md-invalid` | `select` | 311.33 | 40 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-primary-md-required` | `select` | 311.33 | 40 | ✓ | 5.56:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-primary-sm-default` | `select` | 311.34 | 32 | ✓ | 5.56:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-primary-sm-disabled` | `select` | 311.33 | 32 | ✓ | 5.56:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `solid-primary-sm-invalid` | `select` | 311.34 | 32 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-primary-sm-required` | `select` | 311.33 | 32 | ✓ | 5.56:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-primary-xs-default` | `select` | 311.33 | 24 | ✓ | 5.56:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-primary-xs-disabled` | `select` | 311.33 | 24 | ✓ | 5.56:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `solid-primary-xs-invalid` | `select` | 311.33 | 24 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-primary-xs-required` | `select` | 311.34 | 24 | ✓ | 5.56:1 ✓ | — (no-border) | 5.02:1 ✓ |
...
| `solid-secondary-lg-invalid` | `select` | 311.34 | 48 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
...
| `solid-secondary-md-invalid` | `select` | 311.33 | 40 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
...
| `solid-secondary-sm-invalid` | `select` | 311.33 | 32 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
...
| `solid-secondary-xs-invalid` | `select` | 311.34 | 24 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-secondary-xs-required` | `select` | 311.33 | 24 | ✓ | 4.78:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-success-lg-default` | `select` | 311.33 | 48 | ✓ | 7.34:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-success-lg-disabled` | `select` | 311.34 | 48 | ✓ | 7.34:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `solid-success-lg-invalid` | `select` | 311.33 | 48 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-success-lg-required` | `select` | 311.33 | 48 | ✓ | 7.34:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-success-md-default` | `select` | 311.34 | 40 | ✓ | 7.34:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-success-md-disabled` | `select` | 311.33 | 40 | ✓ | 7.34:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `solid-success-md-invalid` | `select` | 311.34 | 40 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-success-md-required` | `select` | 311.33 | 40 | ✓ | 7.34:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-success-sm-default` | `select` | 311.33 | 32 | ✓ | 7.34:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-success-sm-disabled` | `select` | 311.33 | 32 | ✓ | 7.34:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `solid-success-sm-invalid` | `select` | 311.33 | 32 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-success-sm-required` | `select` | 311.34 | 32 | ✓ | 7.34:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-success-xs-default` | `select` | 311.33 | 24 | ✓ | 7.34:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-success-xs-disabled` | `select` | 311.34 | 24 | ✓ | 7.34:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `solid-success-xs-invalid` | `select` | 311.33 | 24 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-success-xs-required` | `select` | 311.33 | 24 | ✓ | 7.34:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-warning-lg-default` | `select` | 311.34 | 48 | ✓ | 7.31:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-warning-lg-disabled` | `select` | 311.33 | 48 | ✓ | 7.31:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `solid-warning-lg-invalid` | `select` | 311.34 | 48 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-warning-lg-required` | `select` | 311.33 | 48 | ✓ | 7.31:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-warning-md-default` | `select` | 311.33 | 40 | ✓ | 7.31:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-warning-md-disabled` | `select` | 311.33 | 40 | ✓ | 7.31:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `solid-warning-md-invalid` | `select` | 311.33 | 40 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-warning-md-required` | `select` | 311.34 | 40 | ✓ | 7.31:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-warning-sm-default` | `select` | 311.33 | 32 | ✓ | 7.31:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-warning-sm-disabled` | `select` | 311.34 | 32 | ✓ | 7.31:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `solid-warning-sm-invalid` | `select` | 311.33 | 32 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-warning-sm-required` | `select` | 311.33 | 32 | ✓ | 7.31:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-warning-xs-default` | `select` | 311.34 | 24 | ✓ | 7.31:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-warning-xs-disabled` | `select` | 311.33 | 24 | ✓ | 7.31:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `solid-warning-xs-invalid` | `select` | 311.34 | 24 | ✓ | 5.08:1 ✓ | — (no-border) | 5.02:1 ✓ |
| `solid-warning-xs-required` | `select` | 311.33 | 24 | ✓ | 7.31:1 ✓ | — (no-border) | 5.02:1 ✓ |
