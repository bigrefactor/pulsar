# Flash_group — a11y measurements (light)
...
|---------|-----|-------|--------|--------|------|--------|-------|
| `position-bottom-center` | `div` | 1280 | 216 | ✓ | 19.27:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `position-bottom-left` | `div` | 1280 | 216 | ✓ | 19.27:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `position-bottom-right` | `div` | 1280 | 216 | ✓ | 19.27:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `position-top-center` | `div` | 1280 | 216 | ✓ | 19.27:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `position-top-left` | `div` | 1280 | 216 | ✓ | 19.27:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `position-top-right` | `div` | 1280 | 216 | ✓ | 19.27:1 ✓ | — (no-border) | — (not-focusable-in-state) |
