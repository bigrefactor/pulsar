...
|---------|-----|-------|--------|--------|------|--------|-------|
| `elevated-danger` | `header` | 926 | 64 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `elevated-info` | `header` | 926 | 64 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `elevated-neutral` | `header` | 926 | 64 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `elevated-primary` | `header` | 926 | 64 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `elevated-secondary` | `header` | 926 | 64 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `elevated-success` | `header` | 926 | 64 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `elevated-warning` | `header` | 926 | 64 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `ghost-danger` | `header` | 926 | 64 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `ghost-info` | `header` | 926 | 64 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `ghost-neutral` | `header` | 926 | 64 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `ghost-primary` | `header` | 926 | 64 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
...
| `solid-warning` | `header` | 926 | 64 | ✓ | 11.69:1 ✓ | 10.3:1 ✓ (bottom) | — (not-focusable-in-state) |
