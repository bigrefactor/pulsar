...
|---------|-----|-------|--------|--------|------|--------|-------|
| `error` | `label` | 115.5 | 18 | ✗ | 4.56:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `required` | `label` | 122.13 | 18 | ✗ | 19.27:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `required-error` | `label` | 136.28 | 18 | ✗ | 4.56:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `size-lg` | `label` | 89.06 | 21 | ✗ | 19.27:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `size-md` | `label` | 90.55 | 18 | ✗ | 19.27:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `size-sm` | `label` | 79.34 | 17 | ✗ | 19.27:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `size-xl` | `label` | 90.81 | 23 | ✗ | 19.27:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `size-xs` | `label` | 65.11 | 15 | ✗ | 19.27:1 ✓ | — (no-border) | — (not-focusable-in-state) |
