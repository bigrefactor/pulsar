# Radio_group — a11y measurements (dark)
...
|---------|-----|-------|--------|--------|------|--------|-------|
| `card` | `label` | 110.14 | 60 | ✓ | 19.27:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `card` | `label` | 110.14 | 60 | ✓ | 19.27:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `card` | `label` | 110.14 | 60 | ✓ | 19.27:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `danger-lg` | `div` | 308.67 | 108 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `danger-md` | `div` | 308.66 | 108 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `danger-sm` | `div` | 308.66 | 108 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `danger-xs` | `div` | 308.67 | 108 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `horizontal` | `div` | 74.14 | 96 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `neutral-lg` | `div` | 308.66 | 108 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `neutral-md` | `div` | 308.66 | 96 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `neutral-sm` | `div` | 308.67 | 96 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `neutral-xs` | `div` | 308.66 | 96 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `primary-lg` | `div` | 308.67 | 108 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `primary-md` | `div` | 308.66 | 108 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `primary-sm` | `div` | 308.66 | 108 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `primary-xs` | `div` | 308.67 | 108 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `secondary-lg` | `div` | 308.66 | 108 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `secondary-md` | `div` | 308.67 | 108 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `secondary-sm` | `div` | 308.66 | 108 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `secondary-xs` | `div` | 308.66 | 108 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `success-lg` | `div` | 308.66 | 108 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `success-md` | `div` | 308.66 | 96 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `success-sm` | `div` | 308.67 | 96 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `success-xs` | `div` | 308.66 | 96 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `warning-lg` | `div` | 308.66 | 108 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `warning-md` | `div` | 308.67 | 108 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `warning-sm` | `div` | 308.66 | 108 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
| `warning-xs` | `div` | 308.66 | 108 | ✓ | 16.98:1 ✓ | — (no-border) | — (not-focusable-in-state) |
