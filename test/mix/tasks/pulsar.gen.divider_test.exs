defmodule Mix.Tasks.Pulsar.Gen.DividerTest do
  ...
  describe "pulsar.gen.divider" do
    test "creates divider component with default naming" do
      ...
      |> assert_generated_component("lib/test_web/components/divider.ex")
      |> apply_igniter!()
    end
    ...
    test "respects custom components module option" do
      ...
      |> assert_generated_component("lib/my_app/custom_components/divider.ex")
      |> apply_igniter!()
    end
  end
end
