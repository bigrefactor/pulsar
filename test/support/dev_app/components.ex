  ...
  @fixture_groups [
    {"Forms",
     [
       ...
       {"Dropzone (solid)", "/components/dropzone/solid"},
       {"Dropzone (outline)", "/components/dropzone/outline"},
       {"Dropzone (ghost)", "/components/dropzone/ghost"},
       {"Dropzone (elevated)", "/components/dropzone/elevated"},
