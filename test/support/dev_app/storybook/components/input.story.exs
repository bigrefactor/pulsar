  ...
  def variations do
    [
      ...
      %Variation{
        ...
        attributes: %{name: "email_filled", type: "email", value: "user@example.com"}
      },
      %Variation{
        id: :invalid_state,
        description: "Invalid/error state",
        attributes: %{name: "email_invalid", type: "email", invalid: true, value: "not-an-email"}
      },
      %Variation{
        id: :disabled_state,
      ...
      %Variation{
        ...
        attributes: %{name: "search_lg", size: "lg", placeholder: "Large search input"}
      }
    ]
  end
end
