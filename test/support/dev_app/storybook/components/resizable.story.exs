  ...
  def variations do
    [
      ...
      %Variation{
        ...
        attributes: %{id: "sb-resizable-collapsible-end", class: "h-64 border border-border rounded-lg"},
        slots: [
          "<:panel><div class=\"p-4\">Primary</div></:panel>",
