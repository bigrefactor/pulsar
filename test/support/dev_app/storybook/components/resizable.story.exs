defmodule Pulsar.DevApp.Storybook.Components.Resizable do
  ...
  def variations do
    [
      %Variation{
        ...
        attributes: %{id: "sb-resizable-horizontal", class: "h-64 border border-border rounded-box"},
        slots: [
      ...
      %Variation{
        ...
        attributes: %{
          ...
          class: "h-80 border border-border rounded-box"
        },
        slots: [
      ...
      %Variation{
        id: :collapsible_end,
        description: "Only the second panel collapsible",
        attributes: %{id: "sb-resizable-collapsible-end", class: "h-64 border border-border rounded-box"},
        slots: [
          "<:panel><div class=\"p-4\">Primary</div></:panel>",
      ...
      %Variation{
        ...
        attributes: %{id: "sb-resizable-collapsible", class: "h-64 border border-border rounded-box"},
        slots: [
