  ...
  def variations do
    ...
    [
      %Variation{
        ...
        attributes: Map.merge(open, %{id: "sb-modal-default", title: "Edit user"}),
        slots: [
      ...
      %Variation{
        ...
        attributes: Map.merge(open, %{id: "sb-modal-large", size: "xl", title: "Wide content"}),
        slots: [body]
      }
    ]
  end
