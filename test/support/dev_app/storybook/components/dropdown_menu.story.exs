  ...
  def attributes do
    [
      %Attr{
        ...
        type: :string,
        required: true,
        doc: "Menu ID. Wires the trigger to the menu."
      },
      %Attr{
        id: :placement,
        type: :string,
  ...
  def variations do
    ...
    actions =
      ~s|<DropdownMenu.dropdown_menu_label>My account</DropdownMenu.dropdown_menu_label>| <>
        ...
        ~s|<DropdownMenu.dropdown_menu_item color="danger" icon="hero-arrow-right-start-on-rectangle" href="#">Sign out</DropdownMenu.dropdown_menu_item>|

    colored =
      ~s|<DropdownMenu.dropdown_menu_item color="primary" icon="hero-star" href="#">Upgrade plan</DropdownMenu.dropdown_menu_item>| <>
        ~s|<DropdownMenu.dropdown_menu_item color="warning" icon="hero-exclamation-triangle" href="#">Archive project</DropdownMenu.dropdown_menu_item>| <>
        ~s|<DropdownMenu.dropdown_menu_separator />| <>
        ~s|<DropdownMenu.dropdown_menu_item color="danger" icon="hero-trash" href="#">Delete</DropdownMenu.dropdown_menu_item>|
    ...
    [
      %Variation{
        ...
        attributes: %{id: "sb-dropdown-menu-default"},
        slots: [trigger, actions]
      },
      %Variation{
        id: :colored_items,
        description: "Items emphasized with the color attr (primary, warning, danger)",
        attributes: %{id: "sb-dropdown-menu-colored-items"},
        slots: [trigger, colored]
      },
      %Variation{
        id: :selections,
        description: "Checkbox and radio items (the menu stays open on toggle)",
        attributes: %{id: "sb-dropdown-menu-selections"},
        slots: [trigger, selections]
      },
      %Variation{
        id: :with_submenu,
        description: "Row actions with a nested submenu",
        attributes: %{id: "sb-dropdown-menu-with-submenu"},
        slots: [trigger, with_submenu]
      },
      %Variation{
        id: :outline_primary,
        description: "Outline primary surface",
        attributes: %{id: "sb-dropdown-menu-outline-primary", variant: "outline", color: "primary"},
        slots: [trigger, actions]
      }
    ]
  end
