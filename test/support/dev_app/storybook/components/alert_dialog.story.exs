defmodule Pulsar.DevApp.Storybook.Components.AlertDialog do
  ...
  # focus-trapped modal (showModal + backdrop). One template backs every variation,
  # so the wrapper dispatches the open event to the dialog within it via
  ...
  def variations do
    ...
    [
      ...
      %Variation{
        ...
        attributes: %{
          id: "sb-alert-dialog-important-not-destructive",
          title: "Publish now?",
          variant: "solid",
          color: "primary",
      ...
      %Variation{
        ...
        attributes: %{
          id: "sb-alert-dialog-outline-danger",
