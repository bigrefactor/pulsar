defmodule Pulsar.DevApp.Storybook.Foundations.DarkMode do
  ...
  /* theme.css — semantic tokens declared with light defaults */
  @theme {
    --color-primary: var(--color-primary-600);
    --color-primary-foreground: var(--color-white);
  }

  /* Dark theme overrides the same tokens — no `dark:` variant needed */
  [data-theme="dark"] {
    --color-primary: var(--color-primary-400);
    --color-primary-foreground: var(--color-gray-950);
  }

  /* Resulting component classes — single source of truth */
          ...
          <div class="psb:space-y-6">
            ...
            <div>
              ...
              <p class="psb:text-sm psb:text-slate-600 psb:mb-3">
                ...
                variant required, because the CSS variable swaps values at runtime:
              </p>
