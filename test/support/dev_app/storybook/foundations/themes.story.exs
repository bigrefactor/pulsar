  ...
  */
  ...
  defp theme_swatches("light") do
    [
      ...
      %{token: "--color-primary", palette: "primary-700", label: "primary", css: "var(--color-primary-700)"},
      %{token: "--color-success", palette: "success-900", label: "success", css: "var(--color-success-900)"},
      %{token: "--color-danger", palette: "danger-700", label: "danger", css: "var(--color-danger-700)"},
