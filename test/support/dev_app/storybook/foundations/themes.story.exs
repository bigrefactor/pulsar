defmodule Pulsar.DevApp.Storybook.Foundations.Themes do
  ...
  */
  ...
  defp theme_card(label, slug, assigns) do
    ...
    <div>
      ...
      <div class="psb:flex psb:gap-1 psb:mb-3">
        ...
        >
          <svg class="psb:h-8 psb:w-full psb:block psb:border border-border">
            <rect width="100%" height="100%" class={s.fill} />
          </svg>
      ...
      >
        ...
        <Flash.flash id="theme-preview-flash" color="success" role="status">
  ...
  # Tokens shown as colored chips in the gallery. `fill` is a literal Tailwind
  # class per entry (Tailwind only generates classes it can find as literal
  # strings in source) so the swatches always match the actual
  # themes/<name>.css files.
  defp theme_swatches("light") do
    [
      %{token: "--color-background", palette: "white", label: "bg", fill: "fill-white"},
      %{token: "--color-surface-1", palette: "gray-50", label: "surf", fill: "fill-gray-50"},
      %{token: "--color-border", palette: "gray-200", label: "border", fill: "fill-gray-200"},
      %{token: "--color-primary", palette: "primary-700", label: "primary", fill: "fill-primary-700"},
      %{token: "--color-success", palette: "success-900", label: "success", fill: "fill-success-900"},
      %{token: "--color-danger", palette: "danger-700", label: "danger", fill: "fill-danger-700"},
      %{token: "--color-foreground", palette: "gray-950", label: "fg", fill: "fill-gray-950"}
    ]
  end

  defp theme_swatches("dark") do
    [
      %{token: "--color-background", palette: "gray-950", label: "bg", fill: "fill-gray-950"},
      %{token: "--color-surface-1", palette: "gray-900", label: "surf", fill: "fill-gray-900"},
      %{token: "--color-border", palette: "gray-800", label: "border", fill: "fill-gray-800"},
      %{token: "--color-primary", palette: "primary-400", label: "primary", fill: "fill-primary-400"},
      %{token: "--color-success", palette: "success-400", label: "success", fill: "fill-success-400"},
      %{token: "--color-danger", palette: "danger-300", label: "danger", fill: "fill-danger-300"},
      %{token: "--color-foreground", palette: "gray-50", label: "fg", fill: "fill-gray-50"}
    ]
  end
  ...
  defp semantic_tokens do
    [
      ...
      %{token: "--color-muted-foreground", role: "Muted text", light: "gray-600", dark: "gray-300"},
      ...
      %{token: "--color-input", role: "Form field border", light: "gray-500", dark: "gray-500"},
      %{token: "--color-ring", role: "Focus ring", light: "primary-600", dark: "primary-400"},
      %{token: "--color-primary", role: "Primary action", light: "primary-700", dark: "primary-400"},
      %{token: "--color-primary-foreground", role: "Text on primary", light: "white", dark: "gray-950"},
      %{token: "--color-success", role: "Success state", light: "success-900", dark: "success-400"},
      %{token: "--color-warning", role: "Warning state", light: "warning-900", dark: "warning-400"},
      %{token: "--color-danger", role: "Danger / destructive", light: "danger-700", dark: "danger-300"}
    ]
  end
