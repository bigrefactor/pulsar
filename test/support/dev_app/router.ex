defmodule Pulsar.DevApp.Router do
  ...
  scope "/", Pulsar.DevApp do
    ...
    live "/components/event-scoping", EventScopingLive, :index
    ...
    live "/components/select/callback", SelectCallbackLive, :index
    ...
    live "/keyboard/combobox", Keyboard.ComboboxLive, :index
    ...
    live "/keyboard/table", Keyboard.TableLive, :index
