defmodule Pulsar.DevApp.StorybookTest do
  ...
  content tree, and includes all 34 leaves (welcome + 25 components +
  ...
  describe "leaves/0 paths" do
    ...
    test "includes all 25 component stories" do
      paths = leaf_paths()
  ...
  describe "leaves/0" do
    test "returns exactly 34 leaves" do
      assert length(Storybook.leaves()) == 34
    end
