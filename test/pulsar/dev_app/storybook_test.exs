defmodule Pulsar.DevApp.StorybookTest do
  ...
  content tree, and includes all 40 leaves (welcome + 31 components +
  ...
  describe "leaves/0 paths" do
    ...
    test "includes all 31 component stories" do
      paths = leaf_paths()
  ...
  describe "leaves/0" do
    test "returns exactly 40 leaves" do
      assert length(Storybook.leaves()) == 40
    end
