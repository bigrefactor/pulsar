defmodule Pulsar.DevApp.StorybookTest do
  ...
  content tree, and includes all 39 leaves (welcome + 30 components +
  ...
  describe "leaves/0 paths" do
    ...
    test "includes all 30 component stories" do
      paths = leaf_paths()
  ...
  describe "leaves/0" do
    test "returns exactly 39 leaves" do
      assert length(Storybook.leaves()) == 39
    end
