defmodule Pulsar.DevApp.StorybookTest do
  ...
  content tree, and includes all 56 leaves (welcome + 47 components +
  ...
  describe "leaves/0 paths" do
    ...
    test "includes all 47 component stories" do
      paths = leaf_paths()
  ...
  describe "leaves/0" do
    test "returns exactly 56 leaves" do
      assert length(Storybook.leaves()) == 56
    end
