defmodule Pulsar.Components.Sidebar do
  ...
  @backdrop_classes [
    ...
    "group-data-[mobile=open]/sidebar:opacity-100",
    "group-data-[mobile=open]/sidebar:duration-normal group-data-[mobile=open]/sidebar:ease-decelerate",
    "group-data-[mobile=open]/sidebar:pointer-events-auto"
  ]
