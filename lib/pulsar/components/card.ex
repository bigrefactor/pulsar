defmodule Pulsar.Components.Card do
  ...
  # Base card classes
  @spec base_card_classes() :: String.t()
  ...
  defp add_interactive_attrs(%{rest: rest} = assigns) do
    if interactive?(rest) do
      rest =
        ...
        |> Map.put_new(:"phx-hook", pulsar_card_hook_name())
  ...
  @spec pulsar_card_hook_name() :: String.t()
  defp pulsar_card_hook_name, do: inspect(__MODULE__) <> ".PulsarCard"
end
