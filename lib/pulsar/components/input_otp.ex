        ...
        export default {
          ...
          boot() {
            ...
            ["focus", "blur", "keyup", "click", "select"].forEach((evt) =>
              this.input.addEventListener(evt, () => this.paint())
            );
          },
          onInput() {
          ...
          paint() {
            ...
            this.slots.forEach((slot, i) => {
              const ch = v[i] || "";
              slot.querySelector("[data-otp-char]").textContent = ch ? (this.mask ? "•" : ch) : "";
              slot.setAttribute("data-filled", ch ? "true" : "false");
              const active = i === activeIndex;
              slot.setAttribute("data-active", active ? "true" : "false");
              slot.querySelector("[data-otp-caret]").classList.toggle("hidden", !(active && !ch));
            });
          },
          maybeComplete(v) {
