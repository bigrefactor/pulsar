defmodule Pulsar.Components.Popover do
  ...
  `left`/`right` and align is `start`/`center`/`end` (default center). The panel
  flips to the opposite side and shifts along the cross axis to stay on screen.
      ...
      export default {
        ...
        position() {
          ...
          if (side === "bottom" || side === "top") {
            ...
            // Shift: clamp horizontally into the viewport.
            ...
            // Shift: clamp vertically into the viewport.
