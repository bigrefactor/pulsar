defmodule Pulsar.Components.Resizable do
  ...
  def resizable(assigns) do
    [panel_one, panel_two] = Enum.take(assigns.panel, 2)
    ...
    assigns =
      ...
      |> assign(:separator_id, "#{assigns.id}-separator")
    ...
    <div
      ...
      {@rest}
    >
      <div class={merge(["min-w-0 min-h-0 flex-1 basis-0 overflow-auto", Map.get(@panel_one, :class) || ""])}>
