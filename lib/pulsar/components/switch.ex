defmodule Pulsar.Components.Switch do
  ...
  @color_config %{
    "danger" => %{
      ...
      solid: %{
        checked:
          "peer-checked:bg-danger/90 peer-checked:hover:bg-danger"
      }
    },
    "info" => %{
      ghost: %{
      ...
      solid: %{
        checked:
          "peer-checked:bg-info/90 peer-checked:hover:bg-info"
      }
    },
    "neutral" => %{
      ghost: %{
      ...
      solid: %{
        checked:
          "peer-checked:bg-neutral/90 peer-checked:hover:bg-neutral"
      }
    },
    "primary" => %{
      ghost: %{
      ...
      solid: %{
        checked:
          "peer-checked:bg-primary/90 peer-checked:hover:bg-primary"
      }
    },
    "secondary" => %{
      ghost: %{
      ...
      solid: %{
        checked:
          "peer-checked:bg-secondary/90 peer-checked:hover:bg-secondary"
      }
    },
    "success" => %{
      ghost: %{
      ...
      solid: %{
        checked:
          "peer-checked:bg-success/90 peer-checked:hover:bg-success"
      }
    },
    "warning" => %{
      ghost: %{
      ...
      solid: %{
        checked:
          "peer-checked:bg-warning/90 peer-checked:hover:bg-warning"
      }
    }
  }
  ...
  defp thumb_variant_classes("outline") do
    "bg-background shadow-md shadow-black/8 border border-border/30"
  end

  defp thumb_variant_classes("ghost") do
    "bg-background shadow-md shadow-black/6"
  end
