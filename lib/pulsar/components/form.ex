defmodule Pulsar.Components.Form do
  ...
  def form(assigns) do
    ...
    # Derive from the form struct's intrinsic id when possible.
    id = assigns.id || derive_form_id(assigns.for)
  ...
  defp derive_form_id(%Form{id: id}) when is_binary(id) and id != "", do: "pulsar-form-" <> id

  defp derive_form_id(_), do: "pulsar-form-" <> Integer.to_string(System.unique_integer([:positive]))
end
