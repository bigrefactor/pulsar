  ...
  def calendar(assigns) do
    ...
    >
      <input
        ...
        value={@single_value}
        form={@form}
        data-cal-value="single"
      />
      <input :if={@start_name} type="hidden" name={@start_name} value={@start_value} form={@form} data-cal-value="start" />
      <input :if={@end_name} type="hidden" name={@end_name} value={@end_value} form={@form} data-cal-value="end" />
